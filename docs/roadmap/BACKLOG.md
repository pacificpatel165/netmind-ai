...
| Ollama + `llama3.2:3b` | `Containerlab` distro (host-installed, not yet containerized) | `docs/setup/07-diagnosis-assistant.md` §2-3 | starts its own background `ollama serve` automatically — don't also run it manually, port 11434 will already be bound. Benchmark/placement/model choice not finalized, see row 21 above |
